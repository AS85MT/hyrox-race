...
- Workout frequency: completed workouts in finished race weeks divided by the number of finished race weeks; the current partial week is excluded. The public calendar and workout log show completed workouts only, with hover/tap details on calendar dots.
