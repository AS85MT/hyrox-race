...
- Workout frequency: completed workouts in finished race weeks divided by the number of finished race weeks; the current partial week is excluded and planned rest days are hidden from the workout log
